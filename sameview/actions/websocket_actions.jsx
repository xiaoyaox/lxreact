...
function handleClose(failCount) {
    if (failCount > MAX_WEBSOCKET_FAILS) {
        ErrorStore.storeLastError({message: Utils.localizeMessage('channel_loader.socketError', 'Please check connection, sameview unreachable. If issue persists, ask administrator to check WebSocket port.')});
    }
