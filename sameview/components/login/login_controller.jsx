...
export default class LoginController extends React.Component {
    ...
    createLoginOptions() {
        ...
        //console.log(this.props.location.query.extra);
        let extraBox = '';
        if (extraParam) {
            ...
            loginControls.push(//
                ...
                >
                    <div className='signup__email-container'>
                        ...
                        默认账户:testsameview@dragonflow.com
                        &nbsp;密码:123456
                        </span>
        ...
        //console.log(global.window.mm_config.EnableOpenServer === 'true' && this.checkSignUpEnabled());
        // console.log(global.window.mm_config.EnableOpenServer);
        // console.log(this.checkSignUpEnabled());
        ...
        if (usernameSigninEnabled || emailSigninEnabled) {
            loginControls.push(
                <div
                    ...
                    className='form-group'
                >
                    <Link to={'/reset_password'} className='login_forgot'>
                        <FormattedMessage
                            id='login.forgot'
