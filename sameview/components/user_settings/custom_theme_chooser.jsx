...
import 'static/bootstrap-colorpicker/js/bootstrap-colorpicker.js';
...
class CustomThemeChooser extends React.Component {
    ...
    componentWillUnmount() {
        ...
        $('.color-picker').colorpicker('destroy');
    }
    ...
    componentDidUpdate() {
        ...
        Constants.THEME_ELEMENTS.forEach((element) => {
            if (theme.hasOwnProperty(element.id) && element.id !== 'codeTheme') {
              let oldColor = $('#' + element.id).colorpicker('getValue').toLowerCase();
              if(oldColor != theme[element.id].toLowerCase()){
                // console.log("colorpicker value:",$('#' + element.id).colorpicker("getValue"),$('#' + element.id).data('colorpicker').color);
