...
export default class TutorialIntroScreens extends React.Component {
    ...
    handleNext() {
        ...
        case 0:
            trackEvent('tutorial', 'tutorial_screen_1_welcome_to_sameview_next');
            break;
        case 1:
            trackEvent('tutorial', 'tutorial_screen_2_how_sameview_works_next');
            break;
        case 2:
    ...
    skipTutorial(e) {
        ...
        switch (this.state.currentScreen) {
        case 0:
            trackEvent('tutorial', 'tutorial_screen_1_welcome_to_sameview_skip');
            break;
        case 1:
            trackEvent('tutorial', 'tutorial_screen_2_how_sameview_works_skip');
            break;
        case 2:
        ...
        return (
            <div>
                <FormattedHTMLMessage
                    ...
                    defaultMessage='<h3>How sameview works:</h3>
