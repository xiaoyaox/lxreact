...
import sameviewIcon from 'images/sameview.svg';
            ...
            <div className='get-app get-android-app'>
                <h1 className='get-app__header'>
                    <FormattedMessage
                        ...
                        defaultMessage='sameview works best if you switch to our Android app'
                    />
                </h1>
                <hr/>
                <div>
                    ...
                    <div className='get-android-app__app-info'>
                        <span className='get-android-app__app-name'>
                            <FormattedMessage
                                ...
                                defaultMessage='sameview for Android'
                            />
                        </span>
                        <span className='get-android-app__app-creator'>
                            <FormattedMessage
                                id='get_app.sameviewInc'
                                defaultMessage='sameview, Inc'
                            />
                        </span>
                    </div>
                </div>
