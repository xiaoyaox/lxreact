            ...
            <div className='get-app get-ios-app'>
                <h1 className='get-app__header'>
                    <FormattedMessage
                        ...
                        defaultMessage='sameview works best if you switch to our iPhone app'
                    />
                </h1>
                <hr/>
                <a
                ...
                <a
                    className='btn btn-primary get-ios-app__open-sameview'
                    href='sameview://'
                >
                    <FormattedMessage
                        id='get_app.opensameview'
                        defaultMessage='Open sameview'
                    />
                </a>
