            ...
            configLoadedFromCluster = (
                ...
                >
                    ...
                    <FormattedHTMLMessage
                        ...
                        defaultMessage='This configuration file was loaded from Node ID {clusterId}. Please see the Troubleshooting Guide in our <a href="http://docs.sameview.com/deployment/cluster.html" target="_blank">documentation</a> if you are accessing the System Console through a load balancer and experiencing issues.'
                        values={{
            ...
            warning = (
                ...
                >
                    ...
                    <FormattedMessage
                        ...
                        defaultMessage='WARNING: These settings may not sync with the other servers in the cluster. High Availability inter-node communication will not start until you modify the config.json to be identical on all servers and restart sameview. Please see the <a href="http://docs.sameview.com/deployment/cluster.html" target="_blank">documentation</a> on how to add or remove a server from the cluster. If you are accessing the System Console through a load balancer and experiencing issues, please see the Troubleshooting Guide in our <a href="http://docs.sameview.com/deployment/cluster.html" target="_blank">documentation</a>.'
                    />
                </div>
            );
        }
                ...
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedHTMLMessage
                            ...
                            defaultMessage='When true, sameview will run in High Availability mode. Please see <a href="http://docs.sameview.com/deployment/cluster.html" target="_blank">documentation</a> to learn more about configuring High Availability for sameview.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='The internal/private URLs of all the sameview servers separated by commas.'
                        />
                    }
