                ...
                <RemoveFileSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='Remove the certificate used to generate the signature on a SAML request to the Identity Provider for a service provider initiated SAML login, when Sameview is the Service Provider.'
                        />
                    }
                ...
                <FileUploadSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='The certificate used to generate the signature on a SAML request to the Identity Provider for a service provider initiated SAML login, when Sameview is the Service Provider.'
                        />
                    }
                    uploadingText={Utils.localizeMessage('admin.saml.uploading.certificate', 'Uploading Certificate...')}
                    disabled={!this.state.enable || !this.state.encrypt}
        ...
        return (
            <SettingsGroup>
                <div className='banner'>
                    <div className='banner__content'>
                        <FormattedHTMLMessage
                            ...
                            defaultMessage='User attributes in SAML server, including user deactivation or removal, are updated in Sameview during user login. Learn more at: <a href=\"https://docs.Sameview.com/deployment/sso-saml.html\">https://docs.Sameview.com/deployment/sso-saml.html</a>'
                        />
                    </div>
                </div>
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedHTMLMessage
                            ...
                            defaultMessage='When true, Sameview allows login using SAML. Please see <a href="http://docs.Sameview.com/deployment/sso-saml.html" target="_blank">documentation</a> to learn more about configuring SAML for Sameview.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='The URL where Sameview sends a SAML request to start login sequence.'
                        />
                    }
                ...
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='When true, Sameview verifies that the signature sent from the SAML Response matches the Service Provider Login URL'
                        />
                    }
                ...
                <TextSetting
                    ...
                    placeholder={Utils.localizeMessage('admin.saml.assertionConsumerServiceURLEx', 'Ex "https://<your-Sameview-url>/login/sso/saml"')}
                    helpText={
                        <FormattedMessage
                            id='admin.saml.assertionConsumerServiceURLDesc'
                            defaultMessage='Enter https://<your-Sameview-url>/login/sso/saml. Make sure you use HTTP or HTTPS in your URL depending on your server configuration. This field is also known as the Assertion Consumer Service URL.'
                        />
                    }
                ...
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='When true, Sameview will decrypt SAML Assertions encrypted with your Service Provider Public Certificate.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='The attribute in the SAML Assertion that will be used to populate the email addresses of users in Sameview.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='The attribute in the SAML Assertion that will be used to populate the username field in Sameview.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='(Optional) The attribute in the SAML Assertion that will be used to populate the first name of users in Sameview.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='(Optional) The attribute in the SAML Assertion that will be used to populate the last name of users in Sameview.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='(Optional) The attribute in the SAML Assertion that will be used to populate the nickname of users in Sameview.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='(Optional) The attribute in the SAML Assertion that will be used to populate the position of users in Sameview.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='(Optional) The attribute in the SAML Assertion that will be used to populate the language of users in Sameview.'
                        />
                    }
