...
export default class LocalizationSettings extends AdminSettings {
    ...
    renderSettings() {
      ...
      //     If you’re manually adding new languages, the <strong>Default Client Language</strong> must be added before saving this setting.<br /><br />Would like to help with translations? Join the <a href="http://translate.Sameview.com/" target="_blank">Sameview Translation Server</a> to contribute.'
      // />
        return (
            <SettingsGroup>
                <DropdownSetting
