                ...
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='When true, Sameview allows login using AD/LDAP'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='The port Sameview will use to connect to the AD/LDAP server. Default is 389.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='The Base DN is the Distinguished Name of the location where Sameview should start its search for users in the AD/LDAP tree.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='The username used to perform the AD/LDAP search. This should typically be an account created specifically for use with Sameview. It should have access limited to read the portion of the AD/LDAP tree specified in the BaseDN field.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='(Optional) Enter an AD/LDAP Filter to use when searching for user objects. Only the users selected by the query will be able to access Sameview. For Active Directory, the query to filter out disabled users is (&(objectCategory=Person)(!(UserAccountControl:1.2.840.113556.1.4.803:=2))).'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='(Optional) The attribute in the AD/LDAP server that will be used to populate the first name of users in Sameview.  When set, users will not be able to edit their first name, since it is synchronized with the LDAP server. When left blank, users can set their own first name in Account Settings.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='(Optional) The attribute in the AD/LDAP server that will be used to populate the last name of users in Sameview. When set, users will not be able to edit their last name, since it is synchronized with the LDAP server. When left blank, users can set their own last name in Account Settings.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='(Optional) The attribute in the AD/LDAP server that will be used to populate the nickname of users in Sameview. When set, users will not be able to edit their nickname, since it is synchronized with the LDAP server. When left blank, users can set their own nickname in Account Settings.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='(Optional) The attribute in the AD/LDAP server that will be used to populate the position field in Sameview.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='The attribute in the AD/LDAP server that will be used to populate the email addresses of users in Sameview.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='The attribute in the AD/LDAP server that will be used to populate the username field in Sameview. This may be the same as the ID Attribute.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='The attribute in the AD/LDAP server that will be used as a unique identifier in Sameview. It should be an AD/LDAP attribute with a value that does not change, such as username or uid. If a user’s ID Attribute changes, it will create a new Sameview account unassociated with their old one. This is the value used to log in to Sameview in the "AD/LDAP Username" field on the sign in page. Normally this attribute is the same as the “Username Attribute” field above. If your team typically uses domain\\username to sign in to other services with AD/LDAP, you may choose to put domain\\username in this field to maintain consistency between sites.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='AD/LDAP Synchronization updates Sameview user information to reflect updates on the AD/LDAP server. For example, when a user’s name changes on the AD/LDAP server, the change updates in Sameview when synchronization is performed. Accounts removed from or disabled in the AD/LDAP server have their Sameview accounts set to “Inactive” and have their account sessions revoked. Sameview performs synchronization on the interval entered. For example, if 60 is entered, Sameview synchronizes every 60 minutes.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='The maximum number of users the Sameview server will request from the AD/LDAP server at one time. 0 is unlimited.'
                        />
                    }
