                ...
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='When true, Sameview allows team creation and account signup using email and password.  This value should be false only when you want to limit signup to a single-sign-on service like OAuth or AD/LDAP.'
                        />
                    }
                ...
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='When true, Sameview allows users to sign in using their email and password.'
                        />
                    }
                ...
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='When true, Sameview allows users to sign in using their username and password.  This setting is typically only used when email verification is disabled.'
                        />
                    }
