    ...
    renderTitle() {
        return (
            <FormattedMessage
                ...
                defaultMessage='Sameview WebRTC (Beta)'
            />
        );
    }
        ...
        return (
            <SettingsGroup>
                <BooleanSetting
                    ...
                    label={
                        <FormattedMessage
                            ...
                            defaultMessage='Enable Sameview WebRTC: '
                        />
                    }
                    helpText={
                        <FormattedHTMLMessage
                            id='admin.webrtc.enableDescription'
                            defaultMessage='When true, Sameview allows making <strong>one-on-one</strong> video calls. WebRTC calls are available on Chrome, Firefox and Sameview Desktop Apps.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    placeholder={Utils.localizeMessage('admin.webrtc.gatewayWebsocketUrlExample', 'Ex "wss://webrtc.Sameview.com:8189"')}
                    helpText={
                        <FormattedMessage
                            id='admin.webrtc.gatewayWebsocketUrlDescription'
                            defaultMessage='Enter wss://<Sameview-webrtc-gateway-url>:<port>. Make sure you use WS or WSS in your URL depending on your server configuration.
                ...
                <TextSetting
                    ...
                    placeholder={Utils.localizeMessage('admin.webrtc.gatewayAdminUrlExample', 'Ex "https://webrtc.Sameview.com:7089/admin"')}
                    helpText={
                        <FormattedMessage
                            id='admin.webrtc.gatewayAdminUrlDescription'
                            defaultMessage='Enter https://<Sameview-webrtc-gateway-url>:<port>/admin. Make sure you use HTTP or HTTPS in your URL depending on your server configuration.
                            Sameview WebRTC uses this URL to obtain valid tokens for each peer to establish the connection.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    placeholder={Utils.localizeMessage('admin.webrtc.stunUriExample', 'Ex "stun:webrtc.Sameview.com:5349"')}
                    helpText={
                        <FormattedMessage
                ...
                <TextSetting
                    ...
                    placeholder={Utils.localizeMessage('admin.webrtc.turnUriExample', 'Ex "turn:webrtc.Sameview.com:5349"')}
                    helpText={
                        <FormattedMessage
