    ...
    renderTitle() {
        return (
            <FormattedMessage
                ...
                defaultMessage='Sameview App Links'
            />
        );
    }
                ...
                <TextSetting
                    ...
                    label={
                        <FormattedMessage
                            ...
                            defaultMessage='Sameview Apps Download Page Link:'
                        />
                    }
                    helpText={
                        <FormattedMessage
                            id='admin.customization.appDownloadLinkDesc'
                            defaultMessage='Add a link to a download page for the Sameview apps. When a link is present, an option to "Download Sameview Apps" will be added in the Main Menu so users can find the download page. Leave this field blank to hide the option from the Main Menu.'
                        />
                    }
                    value=''
