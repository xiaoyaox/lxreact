                ...
                <div className='banner warning'>
                    <div className='banner__content'>
                        <FormattedHTMLMessage
                            ...
                            defaultMessage='<h4 class="banner__heading">Note:</h4><p>Compliance is an enterprise feature. Your current license does not support Compliance. Click <a href="http://sameview.com"target="_blank">here</a> for information and pricing on enterprise licenses.</p>'
                        />
                    </div>
                </div>
            );
                ...
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedHTMLMessage
                            ...
                            defaultMessage='When true, sameview allows compliance reporting from the <strong>Compliance and Auditing</strong> tab. See <a href="https://docs.sameview.com/administration/compliance.html" target="_blank">documentation</a> to learn more.'
                        />
                    }
                ...
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedMessage
                            ...
                            defaultMessage='When true, sameview will generate a daily compliance report.'
                        />
                    }
