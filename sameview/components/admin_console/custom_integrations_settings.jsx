            ...
            <SettingsGroup>
                <BooleanSetting
                    ...
                    helpText={
                        ...
                        // <FormattedHTMLMessage
                        //     id='admin.service.webhooksDescription'
                        //     defaultMessage='When true, incoming webhooks will be allowed. To help combat phishing attacks, all posts from webhooks will be labelled by a BOT tag. See <a href="http://docs.sameview.com/developer/webhooks-incoming.html" target="_blank">documentation</a> to learn more.'
                        // />
                    }
                ...
                <BooleanSetting
                    ...
                    helpText={
                        ...
                        // <FormattedHTMLMessage
                        //     id='admin.service.outWebhooksDesc'
                        //     defaultMessage='When true, outgoing webhooks will be allowed. See <a href="http://docs.sameview.com/developer/webhooks-outgoing.html" target="_blank">documentation</a> to learn more.'
                        // />
                    }
                ...
                <BooleanSetting
                    ...
                    helpText={
                        ...
                        // <FormattedHTMLMessage
                        //     id='admin.service.cmdsDesc'
                        //     defaultMessage='When true, custom slash commands will be allowed. See <a href="http://docs.sameview.com/developer/slash-commands.html" target="_blank">documentation</a> to learn more.'
                        // />
                    }
                ...
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedHTMLMessage
                            ...
                            defaultMessage='When true, sameview can act as an OAuth 2.0 service provider allowing sameview to authorize API requests from external applications. '
                        />
                        // <FormattedHTMLMessage
                        //     id='admin.oauth.providerDescription'
                        //     defaultMessage='When true, sameview can act as an OAuth 2.0 service provider allowing sameview to authorize API requests from external applications. See <a href="https://docs.sameview.com/developer/oauth-2-0-applications.html" target="_blank">documentation</a> to learn more.'
                        // />
                    }
                ...
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedHTMLMessage
                            ...
                            defaultMessage='When true, webhooks, slash commands and other integrations will be allowed to change the username they are posting as. Note: Combined with allowing integrations to override profile picture icons, users may be able to perform phishing attacks by attempting to impersonate other users.'
                        />
                        // <FormattedHTMLMessage
                        //     id='admin.service.overrideDescription'
                        //     defaultMessage='When true, webhooks, slash commands and other integrations, such as <a href="https://docs.sameview.com/integrations/zapier.html" target="_blank">Zapier</a>, will be allowed to change the username they are posting as. Note: Combined with allowing integrations to override profile picture icons, users may be able to perform phishing attacks by attempting to impersonate other users.'
                        // />
                    }
                ...
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedHTMLMessage
                            ...
                            defaultMessage='When true, webhooks, slash commands and other integrations will be allowed to change the profile picture they post with. Note: Combined with allowing integrations to override usernames, users may be able to perform phishing attacks by attempting to impersonate other users.'
                        />
                        // <FormattedHTMLMessage
                        //     id='admin.service.iconDescription'
                        //     defaultMessage='When true, webhooks, slash commands and other integrations, such as <a href="https://docs.sameview.com/integrations/zapier.html" target="_blank">Zapier</a>, will be allowed to change the profile picture they post with. Note: Combined with allowing integrations to override usernames, users may be able to perform phishing attacks by attempting to impersonate other users.'
                        // />
                    }
