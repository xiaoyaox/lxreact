        ...
        return (
            <SettingsGroup>
                ...
                <TextSetting
                    ...
                    placeholder={Utils.localizeMessage('admin.service.siteURLExample', 'Ex "https://sameview.example.com:1234"')}
                    helpText={
                        <FormattedMessage
                            id='admin.service.siteURLDescription'
                            defaultMessage='The URL, including port number and protocol, that users will use to access sameview. This setting is required.'
                        />
                    }
