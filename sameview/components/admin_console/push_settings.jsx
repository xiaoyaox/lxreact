        ...
        if (this.state.pushNotificationServerType === PUSH_NOTIFICATIONS_OFF) {
            sendHelpText = (
                <FormattedHTMLMessage
                    ...
                    defaultMessage='Please see <a href="http://docs.Sameview.com/deployment/push.html#push-notifications-and-mobile-devices" target="_blank">documentation on push notifications</a> to learn more about setup options.'
                />
            );
            ...
            pushServerHelpText = (
                <FormattedHTMLMessage
                    ...
                    defaultMessage='Download <a href="https://itunes.apple.com/us/app/Sameview/id984966508?mt=8" target="_blank">Sameview iOS app</a> from iTunes. Download <a href="https://play.google.com/store/apps/details?id=com.Sameview.Sameview&hl=en" target="_blank">Sameview Android app</a> from Google Play. Learn more about the <a href="http://docs.Sameview.com/deployment/push.html#hosted-push-notifications-service-hpns" target="_blank">Sameview Hosted Push Notification Service</a>.'
                />
            );
            ...
            pushServerHelpText = (
                <FormattedHTMLMessage
                    ...
                    defaultMessage='Download <a href="https://itunes.apple.com/us/app/Sameview/id984966508?mt=8" target="_blank">Sameview iOS app</a> from iTunes. Download <a href="https://play.google.com/store/apps/details?id=com.Sameview.Sameview&hl=en" target="_blank">Sameview Android app</a> from Google Play. Learn more about the <a href="http://docs.Sameview.com/deployment/push.html#test-push-notifications-service-tpns" target="_blank">Sameview Test Push Notification Service</a>.'
                />
            );
        } else {
            pushServerHelpText = (
                <FormattedHTMLMessage
                    ...
                    defaultMessage='Learn more about compiling and deploying your own mobile apps from an <a href="http://docs.Sameview.com/deployment/push.html#enterprise-app-store-eas" target="_blank">Enterprise App Store</a>.'
                />
            );
        }
                ...
                <div className='form-group'>
                    ...
                    <div className='col-sm-8'>
                        ...
                        <FormattedHTMLMessage
                            ...
                            defaultMessage=' I understand and accept the Sameview Hosted Push Notification Service <a href="https://about.Sameview.com/hpns-terms/" target="_blank">Terms of Service</a> and <a href="https://about.Sameview.com/hpns-privacy/" target="_blank">Privacy Policy</a>.'
                        />
                    </div>
                </div>
            );
