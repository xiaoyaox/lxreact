                ...
                <div className='col-sm-8'>
                    ...
                    <p className='help-text no-margin'>
                        <FormattedHTMLMessage
                            ...
                            defaultMessage='Customize your user experience by adding a custom image to your login screen. See examples at <a href="http://docs.sameview.com/administration/config-settings.html#custom-branding" target="_blank">docs.sameview.com/administration/config-settings.html#custom-branding</a>.'
                        />
                    </p>
                </div>
            </div>
