                ...
                <div className='banner'>
                    <div className='banner__content'>
                        <FormattedHTMLMessage
                            ...
                            defaultMessage="<a href='https://docs.Sameview.com/deployment/auth.html' target='_blank'>Multi-factor authentication</a> is available for accounts with AD/LDAP or email login. If other login methods are used, MFA should be configured with the authentication provider."
                        />
                    </div>
                </div>
                <BooleanSetting
                ...
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedHTMLMessage
                            ...
                            defaultMessage="When true, <a href='https://docs.Sameview.com/deployment/auth.html' target='_blank'>multi-factor authentication</a> is required for login. New users will be required to configure MFA on signup. Logged in users without MFA configured are redirected to the MFA setup page until configuration is complete.<br/><br/>If your system has users with login methods other than AD/LDAP and email, MFA must be enforced with the authentication provider outside of Sameview."
                        />
                    }
