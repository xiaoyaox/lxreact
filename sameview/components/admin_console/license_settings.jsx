...
class LicenseSettings extends React.Component {
    ...
    render() {
        ...
        if (global.window.mm_license.IsLicensed === 'true') {
            ...
            edition = 'Sameview Enterprise Edition. Enterprise features on this server have been unlocked with a license key and a valid subscription.';
            licenseType = (
                <div>
                    <p>
                    ...
                    <br/>
                    {'See also '}<a href='https://about.Sameview.com/enterprise-edition-terms/'>{'Enterprise Edition Terms of Service'}</a>{' and '}<a href='https://about.Sameview.com/privacy/'>{'Privacy Policy.'}</a>
                </div>
            );
            ...
            edition = (
                <p>
                    {'Sameview Enterprise Edition. Unlock enterprise features in this software through the purchase of a subscription from '}
                    <a
                        target='_blank'
                        rel='noopener noreferrer'
                        href='https://Sameview.com/'
                    >
                        {'https://Sameview.com/'}
                    </a>
                </p>
                ...
                <div className='col-sm-8'>
                    ...
                    <p className='help-text no-margin'>
                        <FormattedHTMLMessage
                            ...
                            defaultMessage='Upload a license key for Sameview Enterprise Edition to upgrade this server. <a href="http://Sameview.com" target="_blank">Visit us online</a> to learn more about the benefits of Enterprise Edition or to purchase a key.'
                        />
                    </p>
                </div>
            );
