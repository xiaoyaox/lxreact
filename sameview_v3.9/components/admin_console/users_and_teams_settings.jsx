        ...
        return (
            <SettingsGroup>
                ...
                <TextSetting
                    ...
                    placeholder={Utils.localizeMessage('admin.team.restrictExample', 'Ex "corp.3ren.com, 3ren.org"')}
                    helpText={
                        <FormattedMessage
                            id='admin.team.restrictDescription'
                            defaultMessage='Teams and user accounts can only be created from a specific domain (e.g. "3ren.org") or list of comma-separated domains (e.g. "corp.3ren.com, 3ren.org").'
                        />
                    }
                ...
                <DropdownSetting
                    ...
                    values={[
                        {value: RESTRICT_DIRECT_MESSAGE_ANY, text: Utils.localizeMessage('admin.team.restrict_direct_message_any', 'Any user on the 三人即时通 server')},
                    ...
                    helpText={
                        <FormattedHTMLMessage
                            ...
                            defaultMessage='"Any user on the 三人即时通 server" enables users to open a Direct Message channel with any user on the server, even if they are not on any teams together. "Any member of the team" limits the ability to open Direct Message channels to only users who are in the same team.'
                        />
                    }
