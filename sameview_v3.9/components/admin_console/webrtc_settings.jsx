    ...
    renderTitle() {
        return (
            <FormattedMessage
                ...
                defaultMessage='3ren WebRTC (Beta)'
            />
        );
    }
        ...
        return (
            <SettingsGroup>
                <BooleanSetting
                    ...
                    label={
                        <FormattedMessage
                            ...
                            defaultMessage='Enable 3ren WebRTC: '
                        />
                    }
                    helpText={
                        <FormattedHTMLMessage
                            id='admin.webrtc.enableDescription'
                            defaultMessage='When true, 三人即时通 allows making <strong>one-on-one</strong> video calls. WebRTC calls are available on Chrome, Firefox and 三人即时通 Desktop Apps.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    placeholder={Utils.localizeMessage('admin.webrtc.gatewayWebsocketUrlExample', 'Ex "wss://webrtc.3ren.com:8189"')}
                    helpText={
                        <FormattedMessage
                            id='admin.webrtc.gatewayWebsocketUrlDescription'
                            defaultMessage='Enter wss://<3ren-webrtc-gateway-url>:<port>. Make sure you use WS or WSS in your URL depending on your server configuration.
                ...
                <TextSetting
                    ...
                    placeholder={Utils.localizeMessage('admin.webrtc.gatewayAdminUrlExample', 'Ex "https://webrtc.3ren.com:7089/admin"')}
                    helpText={
                        <FormattedMessage
                            id='admin.webrtc.gatewayAdminUrlDescription'
                            defaultMessage='Enter https://<3ren-webrtc-gateway-url>:<port>/admin. Make sure you use HTTP or HTTPS in your URL depending on your server configuration.
                            3ren WebRTC uses this URL to obtain valid tokens for each peer to establish the connection.'
                        />
                    }
                ...
                <TextSetting
                    ...
                    placeholder={Utils.localizeMessage('admin.webrtc.stunUriExample', 'Ex "stun:webrtc.3ren.com:5349"')}
                    helpText={
                        <FormattedMessage
                ...
                <TextSetting
                    ...
                    placeholder={Utils.localizeMessage('admin.webrtc.turnUriExample', 'Ex "turn:webrtc.3ren.com:5349"')}
                    helpText={
                        <FormattedMessage
